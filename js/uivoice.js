...
const UIVoice = (() => {
  ...
  const DICT = {
    ...
    /* ── 教學卡常用字 ── */
    嗨: 'ㄏㄞ', 我: 'ㄨㄛˇ', 是: 'ㄕˋ', 積: 'ㄐㄧ', 木: 'ㄇㄨˋ', 精: 'ㄐㄧㄥ', 靈: 'ㄌㄧㄥˊ',
    歡: 'ㄏㄨㄢ', 迎: 'ㄧㄥˊ', 來: 'ㄌㄞˊ', 工: 'ㄍㄨㄥ', 坊: 'ㄈㄤ',
    跟: 'ㄍㄣ', 著: '˙ㄓㄜ', 闖: 'ㄔㄨㄤˇ', 你: 'ㄋㄧˇ', 就: 'ㄐㄧㄡˋ',
    能: 'ㄋㄥˊ', 做: 'ㄗㄨㄛˋ', 接: 'ㄐㄧㄝ', 準: 'ㄓㄨㄣˇ', 備: 'ㄅㄟˋ',
    好: 'ㄏㄠˇ', 嗎: '˙ㄇㄚ', 探: 'ㄊㄢˋ', 險: 'ㄒㄧㄢˇ',
    這: 'ㄓㄜˋ', 個: 'ㄍㄜˋ', 箱: 'ㄒㄧㄤ', 的: '˙ㄉㄜ',
    左: 'ㄗㄨㄛˇ', 每: 'ㄇㄟˇ', 顏: 'ㄧㄢˊ', 都: 'ㄉㄡ', 類: 'ㄌㄟˋ',
    黃: 'ㄏㄨㄤˊ', 藍: 'ㄌㄢˊ', 紫: 'ㄗˇ', 裡: 'ㄌㄧˇ', 看: 'ㄎㄢˋ',
    它: 'ㄊㄚ', 們: '˙ㄇㄣ', 拖: 'ㄊㄨㄛ', 中: 'ㄓㄨㄥ', 間: 'ㄐㄧㄢ',
    地: 'ㄉㄧˋ', 用: 'ㄩㄥˋ',
    舞: 'ㄨˇ', 台: 'ㄊㄞˊ', 會: 'ㄏㄨㄟˋ', 在: 'ㄗㄞˋ', 上: 'ㄕㄤˋ',
    表: 'ㄅㄧㄠˇ', 演: 'ㄧㄢˇ', 玩: 'ㄨㄢˊ', 時: 'ㄕˊ', 候: 'ㄏㄡˋ',
    可: 'ㄎㄜˇ', 以: 'ㄧˇ', 滑: 'ㄏㄨㄚˊ', 鼠: 'ㄕㄨˇ', 把: 'ㄅㄚˇ',
    喜: 'ㄒㄧˇ', 位: 'ㄨㄟˋ', 置: 'ㄓˋ', 喔: '˙ㄛ',
    貓: 'ㄇㄠ', 咪: 'ㄇㄧ', 蘋: 'ㄆㄧㄥˊ', 果: 'ㄍㄨㄛˇ',
    讓: 'ㄖㄤˋ', 起: 'ㄑㄧˇ', 從: 'ㄘㄨㄥˊ', 拉: 'ㄌㄚ', 再: 'ㄗㄞˋ',
    進: 'ㄐㄧㄣˋ', 肚: 'ㄉㄨˇ', 子: '˙ㄗ', 卡: 'ㄎㄚˇ', 住: 'ㄓㄨˋ', 面: 'ㄇㄧㄢˋ',
    綠: 'ㄌㄩˋ', 試: 'ㄕˋ', 右: 'ㄧㄡˋ', 往: 'ㄨㄤˇ', 前: 'ㄑㄧㄢˊ', 走: 'ㄗㄡˇ',
    盤: 'ㄆㄢˊ', 兩: 'ㄌㄧㄤˇ', 組: 'ㄗㄨˇ', 改: 'ㄍㄞˇ', 樣: 'ㄧㄤˋ',
    聽: 'ㄊㄧㄥ', 指: 'ㄓˇ', 揮: 'ㄏㄨㄟ',
    請: 'ㄑㄧㄥˇ', 要: 'ㄧㄠˋ', 目: 'ㄇㄨˋ', 標: 'ㄅㄧㄠ', 區: 'ㄑㄩ', 或: 'ㄏㄨㄛˋ',
    給: 'ㄍㄟˇ', 裝: 'ㄓㄨㄤ', 魔: 'ㄇㄛˊ', 法: 'ㄈㄚˇ',
    天: 'ㄊㄧㄢ', 掉: 'ㄉㄧㄠˋ', 段: 'ㄉㄨㄢˋ', 比: 'ㄅㄧˇ', 較: 'ㄐㄧㄠˋ', 難: 'ㄋㄢˊ',
    幫: 'ㄅㄤ', 然: 'ㄖㄢˊ', 後: 'ㄏㄡˋ', 程: 'ㄔㄥˊ', 式: 'ㄕˋ',
    長: 'ㄓㄤˇ', 什: '˙ㄕ', 麼: '˙ㄇㄜ',
    去: 'ㄑㄩˋ', 顆: 'ㄎㄜ', 畢: 'ㄅㄧˋ', 業: 'ㄧㄝˋ', 囉: '˙ㄌㄛ',
    恭: 'ㄍㄨㄥ', 計: 'ㄐㄧˋ', 師: 'ㄕ', 記: 'ㄐㄧˋ', 得: '˙ㄉㄜ',
    連: 'ㄌㄧㄢˊ', 傳: 'ㄔㄨㄢˊ', 朋: 'ㄆㄥˊ', 友: 'ㄧㄡˇ', 想: 'ㄒㄧㄤˇ', 隨: 'ㄙㄨㄟˊ',
    過: 'ㄍㄨㄛˋ',
    /* ── 共通常用字 ── */
    了: '˙ㄌㄜ', 下: 'ㄒㄧㄚˋ', 一: 'ㄧ', 步: 'ㄅㄨˋ', 跳: 'ㄊㄧㄠˋ', 躍: 'ㄩㄝˋ',
    方: 'ㄈㄤ', 向: 'ㄒㄧㄤˋ', 大: 'ㄉㄚˋ', 小: 'ㄒㄧㄠˇ',
  };
